...
@Service
public class WeatherExportCsvServiceImpl implements ExportCsvService<WeatherDayDataEntity> {
    @Override
    public void printRecord(CSVPrinter printer, WeatherDayDataEntity item) throws IOException {
        printer.printRecord(
                item.getDay(),
                item.getAmount(),
